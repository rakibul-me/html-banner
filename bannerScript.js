...
function animate(id){
    if(id==1){
        document.getElementsByClassName('image1')[0].style.display = "none";
...
function firstAnimation(){
    ...
    var splitText1 = acAnimated.Plugins.SplitText(text1, {words: 1, chars: 1, spacing: 10});
    ...
    timeline.to('.image', {ease: 'expo', duration: 0.5, opacity: 1, x: 0})
        ...
        .to('#text2 div div, #text2 div div div', {delay: 0.5, stagger: 0.03, duration: 0.2, x: 0, y: 0, opacity: 1})
...
function secondAnimation(){
    gsap.set('.image1', {x: 300, opacity: 0});
    var text5 = document.getElementById('text5');
    var splitText5 = acAnimated.Plugins.SplitText(text5, {words: 1, chars: 1, spacing: 10});
    var timeline1 = gsap.timeline({repeat: -1, repeatDelay: 2.5});
    gsap.set('#text3', {x: 200, y: 0, opacity: 0});
    gsap.set('#text4', {x: 200, y: 0, opacity: 0});
    gsap.set('#text5 div div, #text5 div div div', {opacity: 0, x: -100, y: -50});
    gsap.set('#secondButton', {x: 0, y: -50, opacity: 0});
    timeline1.to('.image1', {ease: 'expo', duration: 0.5, opacity: 1, x: 0})
        .to('#text3', {duration: 0.5, ease: 'bounce', x: 0, y: 0, opacity: 1})
        .to('#text4', {duration: 0.5, ease: 'bounce', x: 0, y: 0, opacity: 1}, '-=0.1')
        .to('#text5 div div, #text5 div div div', {stagger: 0.03, duration: 0.2, x: 0, y: 0, opacity: 1})
